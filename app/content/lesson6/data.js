(function (scope) {
    ...
    s.contentMapData = [  
        ...
        // index 1,
        {
         ...
         {
            mapCards: [
                {route:"200_0", title:"THE SCATTERING ANGLE", group:"angle" },
                {route:"200_1", title:"incident photon impact parameter", group:"angle"     },
                {route:"200_2", title:"scattering angle and scatterer", group:"angle"  },  
                {route:"200_3", title:"the scattered photon angle", group:"angle"   }, 
                {route:"200_4", title:"angle & recoil electron (graph)", group:"angle"  },
                {route:"200_5", title:"level summary (angle)", group:"angle"           },  
                {route:"200_6", title:"level quiz (angle)",   icons:["quiz"], group:"angle" },            
            ],
        },
         // index 3,
         {
            mapCards: [
                {route:"300_0", title:"INCIDENT PHOTON ENERGY", group:"energy"    },
                {route:"300_1", title:"energy of incident x-ray", group:"energy"   },
                {route:"300_2", title:"energy & scatterer", group:"energy"         },  
