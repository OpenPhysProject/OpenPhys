...
"use strict"
	...
	function MultiSpinTop() {
		...
		initA();
		initMultiSpin();
		animateMultiSpin();	// keeps on going, until some event occurs.
	}

	function getSaturation(){
		// get the color saturation from a slider
		var output1 = document.getElementById("outParam1MultiSpin");
		output1.innerHTML = "Colour: " + slider1MultiSpin.value + " %";
		slider1MultiSpin.oninput = function() { sat = parseFloat(this.value);  output1.innerHTML ="Colour: " + sat + " %"; }
		}

	function getGx(){
		// get the gradient from a slider
		var output2 = document.getElementById("outParam2MultiSpin");
		output2.innerHTML = "Gy: " + slider2MultiSpin.value + " mT/m";
		slider2MultiSpin.oninput = function() { Gx = parseFloat(this.value); output2.innerHTML = "Gy: " + Gx + " mT/m"; }
		}

	function getGyA(){
		// get the gradient from a slider
		var output3 = document.getElementById("outParam3MultiSpin");
		output3.innerHTML = "Gx: " + slider3MultiSpin.value + " mT/m";
		slider3MultiSpin.oninput = function() { Gy = parseFloat(this.value); output3.innerHTML = "Gx: " + Gy + " mT/m"; }
		}

	function getNX(){
		// get the NX from a slider
		var output4 = document.getElementById("outParam4MultiSpin");
		output4.innerHTML = "# spins: " + slider4MultiSpin.value + " ";
		slider4MultiSpin.oninput = function() { nx = parseFloat(this.value); output4.innerHTML = " # spins: " + nx + " "; }
		}

	function getSpinArrowLength(){
		// get ObjLen from a slider
		var output5 = document.getElementById("outParam5MultiSpin");
		output5.innerHTML = "Spin Size: " + slider5MultiSpin.value + " ";
		slider5MultiSpin.oninput = function() {var ObjLen = parseFloat(this.value); output5.innerHTML = "Spin Size: " + 100*ObjLen + " "; }
		return;
		}
	...
	function initMultiSpin() {
		...
		Gx = 0;  slider2MultiSpin.value = Gx;
		Gy = 0;  slider3MultiSpin.value = Gy;
		var ObjLen = slider5MultiSpin.value/100.0;
		ny     = nx;
		nOBJ   = nx * ny;  // the objects are the spins
		...
		var animateMultiSpin = function () {
			...
			requestAnimationFrame( animateMultiSpin ); // so this routine animateMultiSpin() gets called repeatedly
