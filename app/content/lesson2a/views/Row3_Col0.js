...
(function () {
    ...
    p.template= JST['app/content/lesson2a/templates/Row3_Col0.ejs'];     // template used to create html for this view
...
//   };   
    ...
    OER.Views.Nucleus.StructureDecay = Backbone.View.extend(p, s);    
