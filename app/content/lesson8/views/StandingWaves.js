...
(function () {
    ...
    p.template= JST['app/content/lesson1/templates/R2_Standing.ejs'];     // template used to create html for this view
...
//===================================================//
   ...
   // ============== EVOLUTION ================ //
    ...
    OER.Views.ElectronicStructureOfTheAtom.StandingWaves = Backbone.View.extend(p, s);    
