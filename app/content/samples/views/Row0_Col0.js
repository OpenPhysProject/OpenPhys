// This is js code to give a page custom behavior
// js files like this one need to be loaded in app/index.html
OER.Views = OER.Views || {};
OER.Views.SampleLesson = OER.Views.SampleLesson || {};  // SampleLesson is take from data.js route property
...
(function () {
     ...
     * @constructor
    */
    // SamplePage is taken from data.js contentMapData first path first page route property
    OER.Views.SampleLesson.SamplePage = Backbone.View.extend({
         ...
         *  @property template
         */
        template: JST['app/content/sample/templates/Row0_Col0.ejs'],    // points to related page template
