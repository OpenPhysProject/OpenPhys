...
(function (scope) {
    ...
    s.preview = "/content/samples/assets/logo-icon.svg";    //svg image that is shown on the main page lesson tile
    s.route = "samplesLesson"; //Url shown when you click on lesson tile and can be used as a link, for example this would be http://openphys.med.ualberta.ca/sampleLesson
    ...
    scope.samples = s;  // this is the name we give the data in our project so we can reference it in app/scripts/main.js loadData function
