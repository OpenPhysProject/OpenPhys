...
(function () {
    ...
    p.template= JST['app/content/lesson1/templates/R1_Travelling.ejs'];     // template used to create html for this view
    ...
    p.tick = function(event) {
        ...
        //
        // Text 
        this.txt = new createjs.Text("Traveling Waves", "24px Arial", "#FFF");
...
//        this.drawWave(1.5,   0, 320, wavespeed, "yellow");
   ...
   // ============== EVOLUTION ================ //
    ...
    OER.Views.ElectronicStructureOfTheAtom.Waves = Backbone.View.extend(p, s);    
